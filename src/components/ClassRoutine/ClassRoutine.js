...
const ClassRoutine = () => {
    return (
        <div>
            <div className="container bg-gray-200 p-2 mx-auto sm:p-4 text-slate-200">
	<h2 className="mb-4 text-2xl font-semibold leading-tight text-black">Class Routine</h2>
	<div className="overflow-x-auto">
		<table className="w-full  p-6 text-xs text-left whitespace-nowrap bg-gray-400">
			...
			<tbody className="border-b bg-gray-700 border-gray-700">
				<tr>
